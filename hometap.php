...
<h3>Water Connection Applications</h3>       
 <div class="container">
            <?php
            
                
		$query = "select * from `listtap`;";
...
<tr><td><h4 class="jumbotron-heading"><?php echo $row['name'] ?></h4></td>
			...
			<td> <?php echo $row['date'] ?></td>
                     <td> <p>
                        <a href="accepttap.php?id=<?php echo $row['id'] ?>" class="btn btn-primary my-2">Accept</a>
                        <a href="rejecttap.php?id=<?php echo $row['id'] ?>" class="btn btn-secondary my-2">Reject</a>
                      </p></td></table>
