 ...
 <html lang="en">
  <head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
        <title>TAP Connection Application</title>
 </head>
<?php
...
$c=$_POST['c'];
$date=$_POST['date'];
          $query = "INSERT INTO `listtap`(`id`,`name`,`taxno`,`noc`,`address`,`c`,date) VALUES ('$id','$name','$taxno','$noc','$address','$c','$date');";
...
<body>
 ...
 <h1>WATER Connection Application</h1>
...
<label for="taxno"><b>Municipal TAX no.</b></label>
 ...
 <label for="noc"><b>Number of connections</b></label>
     
    
  <label for="sel1"> (select one):</label>
      <select class="form-control" id="sel1" name="noc" required>
        <option>1</option>
        <option>2</option>
